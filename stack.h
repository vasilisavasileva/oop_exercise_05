...
namespace containers {
	...
	private:
		...
		static std::unique_ptr<element> pop_impl(std::unique_ptr<element> cur);
	...
	template<class T>
	std::unique_ptr<typename stack<T>::element> stack<T>::push_impl(std::unique_ptr<element> cur, const T& value) {
		if (cur != nullptr) {
	...
	template<class T>
	std::unique_ptr<typename stack<T>::element> stack<T>::pop_impl(std::unique_ptr<element> cur) {
